...
export declare enum StagesSleepState {
    deep = "deep",
    light = "light",
    rem = "rem",
    wake = "wake"
}
export declare enum ClassicSleepState {
    asleep = "asleep",
    awake = "awake",
    restless = "restless"
}
export declare enum SleepType {
    classic = "classic",
    stages = "stages"
}
